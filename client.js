...
// 6. Complete this function. It needs to be given an array of tile objects. The function will use a for-loop and 
// return the sum of all the scores in the given array.

function sumTiles(anArray) {
let sumAllArray = 0;
for (let tile of anArray){
  sumAllArray += tile.score 
}
return sumAllArray;
}
